"""
TOPP3-SOCP results: a(s), b(s)=s̈, and s(t) for SCP iterations 1 and 2.
Run from the project root:  python scripts/plot_topp3_socp.py
"""
...
d1 = pd.read_csv("output/data/topp3_socp_iter1.csv")
d2 = pd.read_csv("output/data/topp3_socp_iter2.csv")
t1 = pd.read_csv("output/data/topp3_socp_iter1_traj.csv")
t2 = pd.read_csv("output/data/topp3_socp_iter2_traj.csv")
...
out = "output/plot_topp3_socp.png"
